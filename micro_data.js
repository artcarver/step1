    ...
    organisms: [
      {
        ...
        virulence: "**Protein A:** binds IgG Fc region → blocks opsonization and phagocytosis.\n**Coagulase:** converts fibrinogen → fibrin clot → walled-off abscess (protects from immune clearance).\n**PVL (Panton-Valentine leukocidin):** destroys neutrophils → severe skin/soft tissue infections and necrotizing pneumonia (community-acquired MRSA).\n**Exotoxins:**\n— **TSST-1** (superantigen — bypasses MHC II, directly activates up to 20% of all T cells → cytokine storm → TSS).\n— **Exfoliatin A/B** (serine proteases that cleave **desmoglein-1** in the granular layer of the epidermis → SSSS).\n— **Enterotoxin** (heat-stable preformed toxin → food poisoning via emetic center stimulation).\n**MRSA mechanism:** mecA gene encodes **PBP2a** (altered penicillin-binding protein with low β-lactam affinity) → resistance to all penicillins and cephalosporins.",
        disease: "**Skin/soft tissue:** folliculitis (hair follicle), furuncles (boil), carbuncles (multiple furuncles), impetigo (bullous and non-bullous crusted), cellulitis, wound infections.\n**Systemic:** bacteremia, endocarditis (IV drug users → **tricuspid valve**, right-sided; normal valves → any valve). Septic emboli to lungs (IVDU), kidneys, brain.\n**Bone/joint:** osteomyelitis (**#1 cause overall** — especially hematogenous in children; long bones), septic arthritis.\n**Toxin-mediated:**\n— **TSS:** tampon use, surgical wound packing → fever, diffuse erythroderma ('sunburn'), hypotension, multi-organ involvement, desquamation of palms/soles at 1–2 weeks.\n— **SSSS (Ritter disease):** neonates and immunocompromised adults; superficial blistering and sloughing; Nikolsky sign positive; spares mucous membranes (unlike TEN).\n— **Food poisoning:** 1–6h onset (preformed toxin), N/V, cramping, no fever, self-limited in 24h.",
        lab_diagnosis: "**Gram stain:** GP cocci in clusters ('grapes').\n**Culture:** Blood agar — large, gold/yellow colonies (staphyloxanthin pigment), **β-hemolysis**. Mannitol salt agar (MSA) — yellow halo (ferments mannitol; selective and differential for S. aureus).\n**Tests:** Catalase positive (bubbles with H₂O₂ — distinguishes all Staph from Strep). Coagulase positive (tube or slide latex agglutination — distinguishes S. aureus from CoNS).\n**MRSA detection:** PCR for mecA gene, or chromogenic agar (MRSA Select); nasal swab for surveillance screening.",
      ...
      },
      {
        ...
        virulence: "**M protein:** antiphagocytic (blocks C3b deposition), anti-complement, **molecular mimicry** with cardiac myosin/valve tissue → rheumatic fever after untreated pharyngitis.\n**Streptolysin O (SLO):** β-hemolysis; immunogenic → **anti-streptolysin O (ASO) titer** rises after pharyngitis (not skin infections).\n**Streptolysin S (SLS):** oxygen-stable β-hemolysis; non-immunogenic.\n**Streptokinase:** dissolves fibrin clots → spreading infection.\n**Hyaluronidase ('spreading factor'):** degrades connective tissue → rapid tissue spread.\n**Pyrogenic exotoxins A/B/C (SPE):** superantigens → scarlet fever, streptococcal TSS.\n**DNase B:** immunogenic after both pharyngitis and skin infections → **anti-DNase B titer** rises after either.",
        disease: "**Pharyngitis:** exudative tonsillitis, NO cough (cough suggests viral), fever, anterior cervical LAD — use Centor criteria to guide testing.\n**Impetigo (non-bullous):** honey-crusted ulcerations on exposed skin of children; distinct from bullous impetigo (S. aureus).\n**Scarlet fever:** pharyngitis + sandpaper/papular erythematous rash (spares face circumorally), **strawberry tongue**, **Pastia lines** (linear petechiae in skin folds).\n**Cellulitis and erysipelas** (well-demarcated, raised border → dermis/superficial lymphatics).\n**Necrotizing fasciitis:** 'flesh-eating,' rapidly spreading along fascial planes — surgical emergency; **gas in tissue on imaging**.\n**Streptococcal TSS:** associated with invasive soft tissue infections; shock + organ failure.\n**Post-streptococcal sequelae (non-suppurative):**\n— **Rheumatic fever:** follows pharyngitis ONLY (not skin); prevented by antibiotic treatment; Jones criteria (carditis, polyarthritis, chorea, erythema marginatum, subcutaneous nodules).\n— **PSGN:** follows pharyngitis OR impetigo; immune complex deposition in glomeruli; **NOT prevented by antibiotics**; hematuria, hypertension, edema, low C3.",
        lab_diagnosis: "**Gram stain:** GP cocci in chains.\n**Culture:** Blood agar — small, translucent colonies with large zone of **β-hemolysis**.\n**Tests:** Rapid strep antigen test (RADT) — high specificity; negative RADT in children should be confirmed by culture. **Bacitracin-sensitive** (disk test — zone of inhibition distinguishes GAS from GBS). **PYR positive** (yellow color change).\n**Serology:** ASO titer (rises after pharyngitis); Anti-DNase B (rises after both pharyngitis and impetigo — preferred for PSGN workup).",
      ...
      },
      {
        ...
        disease: "**Neonatal disease (most critical):**\n— **Early-onset (0–7 days):** sepsis, pneumonia, meningitis — from vertical transmission during delivery in colonized mothers (maternal vaginal/rectal colonization 20–30%).\n— **Late-onset (7 days–3 months):** meningitis, bacteremia — from environmental/nosocomial acquisition; higher risk of neurological sequelae.\n**Maternal/adult disease:**\n— UTI and pyelonephritis in pregnant women.\n— Chorioamnionitis, postpartum endometritis.\n— Bacteremia, septic arthritis, and pneumonia in **elderly, diabetic, and immunocompromised** patients.",
      ...
      },
      {
        ...
        disease: "**Most common cause of:**\n— **Community-acquired pneumonia (CAP):** lobar consolidation, rust-colored sputum, herpes labialis reactivation, pleuritic chest pain.\n— **Bacterial meningitis** in adults >50 years (and in children post-Hib vaccine era).\n— **Otitis media** and **sinusitis** in children (alongside H. influenzae).\n**Asplenic patients (surgical or functional — sickle cell, celiac):** bacteremia is rapidly fatal (**overwhelming post-splenectomy infection, OPSI**). 'SHiN' = encapsulated organisms most feared: S. pneumoniae, H. influenzae type b, N. meningitidis.",
        lab_diagnosis: "**Gram stain:** lancet-shaped GP diplococci (pairs of oval cocci with pointed ends).\n**Culture:** Blood agar — small, **α-hemolytic** (green) colonies with a central depression ('checker piece' or 'draughtsman' morphology) due to autolysis. Mucoid if heavily encapsulated.\n**Tests:** **Optochin-sensitive** (zone of inhibition ≥14mm — distinguishes from viridans Strep which is resistant). **Bile-soluble** (sodium deoxycholate lyses colonies — positive = dissolve). **Quellung reaction:** capsule swells with type-specific antisera (classic confirmatory test). **Urine antigen test:** highly sensitive for serogroup 1 (especially useful in antibiotic-pretreated pneumonia).",
        tx: "**Susceptible strains:** penicillin G.\n**Drug-resistant S. pneumoniae (DRSP):** ceftriaxone (PBP2x mutations); **vancomycin** for high-level resistance.\n**Meningitis:** ceftriaxone + vancomycin (empiric) + **dexamethasone** (given before or with first antibiotic dose — reduces TNF-mediated inflammation, **decreases hearing loss** and neurological sequelae).\n**Vaccines:**\n— **PCV15/PCV20** (pneumococcal conjugate vaccines): children ≥2 months; adults ≥65 and high-risk adults.\n— **PPSV23** (polysaccharide, not conjugated): adults ≥65, asplenic, immunocompromised.",
      ...
      },
      {
        ...
        disease: "**Subacute bacterial endocarditis (SBE):**\n— On **previously damaged native valves** (rheumatic heart disease, MVP with regurgitation, bicuspid aortic valve, congenital defects).\n— Entry portal: **dental procedures** (bacteremia with oral viridans Strep).\n— Insidious onset over weeks–months: low-grade fever, malaise, weight loss.\n— Peripheral embolic stigmata: **Osler nodes** (painful — fingertips), **Janeway lesions** (painless — palms/soles), **Roth spots** (retinal), **splinter hemorrhages**.\n**S. mutans:** dental caries (most prevalent infectious disease worldwide).\n**S. bovis (S. gallolyticus) bacteremia/endocarditis:** strongly associated with **colorectal carcinoma** — colonoscopy is mandatory upon diagnosis.",
    ...
    organisms: [
      {
        ...
        virulence: "**Poly-D-glutamate capsule:** protein capsule (unique — not polysaccharide); antiphagocytic; encoded on pXO2 plasmid.\n**Anthrax toxin** (encoded on pXO1 plasmid) — three components that act combinatorially:\n— **Protective antigen (PA):** binds cell surface receptor → forms a pore → delivers EF and LF intracellularly.\n— **Edema factor (EF):** calmodulin-dependent **adenylate cyclase** → ↑↑cAMP → massive edema.\n— **Lethal factor (LF):** zinc metalloprotease → cleaves **MAPKK** → inhibits cell signaling → macrophage death → cytokine storm.",
        disease: "**Cutaneous anthrax (95% of cases):** painless papule → fluid-filled vesicle → **painless necrotic black eschar** with dramatic surrounding non-pitting gelatinous edema. Heals with treatment; 20% fatal if untreated.\n**Inhalation anthrax ('woolsorter's disease'):** spores inhaled → phagocytosed by alveolar macrophages → transported to mediastinal lymph nodes → germination → hemorrhagic mediastinitis. Biphasic: flu-like prodrome → rapid deterioration, **widened mediastinum on CXR**, hemorrhagic pleural effusions. >80% fatal even with treatment.\n**GI anthrax:** from ingesting undercooked contaminated meat (spores in herbivore products); severe abdominal pain, bloody diarrhea, septicemia.",
      ...
      },
      {
        ...
        virulence: "**Emetic toxin (cereulide):**\n— **Heat-stable, preformed** in food (survives 126°C for 90 min — not destroyed by reheating).\n— Stimulates vagal afferents and 5-HT₃ receptors → vomiting center stimulation.\n— Mechanism: depsipeptide that disrupts mitochondrial fatty acid oxidation.\n**Diarrheal enterotoxins (Hbl/Nhe):**\n— **Heat-labile,** produced in the small intestine after spore ingestion.\n— Form pores in intestinal epithelium → secretory diarrhea.\n**Spores** survive initial cooking; germinate during cooling; toxin/organism replicates at room temperature.",
        disease: "**Emetic syndrome (S. aureus mimic):**\n— Onset **1–6h** (short, due to preformed toxin).\n— **Nausea and projectile vomiting** dominant; cramping, minimal diarrhea.\n— Classic setting: **reheated fried rice** (rice cooled and left at room temperature before serving).\n— Self-limited in 6–24h.\n**Diarrheal syndrome (C. perfringens mimic):**\n— Onset **8–16h** (longer, toxin produced in gut).\n— **Profuse watery diarrhea** + cramping; minimal vomiting.\n— Classic setting: meat dishes, sauces, vegetables.\n— Self-limited in 12–24h.",
      ...
      },
      {
        ...
        disease: "**Generalized tetanus (most common):**\n— Trismus ('lockjaw') — masseter spasm, inability to open mouth.\n— **Risus sardonicus** — sustained spasm of facial muscles → sardonic grin.\n— **Opisthotonus** — arched back from simultaneous spasm of paraspinal extensors.\n— Autonomic instability: tachycardia, hypertension, diaphoresis, arrhythmias (major cause of death).\n— Mental status is **clear** (toxin does not cross BBB).\n**Neonatal tetanus:** infection of umbilical stump in infants of unvaccinated mothers; high mortality; common in developing nations.\n**Localized tetanus:** limited to muscles near wound; can progress to generalized.",
        ...
        tx: "1. **Human tetanus immunoglobulin (HTIG):** neutralizes unbound circulating toxin (toxin already bound to neurons cannot be neutralized).\n2. **Wound debridement:** remove necrotic tissue and foreign bodies (eliminate spore source).\n3. **Metronidazole** (or penicillin G): kills vegetative organisms.\n4. **Benzodiazepines** (diazepam, midazolam): muscle relaxation, GABAergic compensation.\n5. **Mechanical ventilation:** for respiratory failure from chest wall rigidity.\n**Prophylaxis:** Td booster every 10 years; Tdap once in adults (includes pertussis coverage).",
      ...
      },
      {
        ...
        disease: "**Food-borne botulism:** pre-formed toxin in improperly canned/preserved foods (home-canned vegetables, fermented fish). Nausea/vomiting → **descending symmetric flaccid paralysis** (cranial nerves first: diplopia, dysarthria, dysphagia → descending to respiratory muscles). Normal mental status. No fever.\n**Infant botulism (most common form in US):** **honey before age 1** or environmental soil → spore ingestion → germination in immature gut → toxin production in vivo. 'Floppy baby,' weak cry, poor feeding, constipation, constipated.\n**Wound botulism:** contaminated puncture wounds, IV drug use (**black tar heroin**) → local toxin production.\n**Iatrogenic botulism:** cosmetic/therapeutic overdose of botulinum toxin injections.",
      ...
      },
      {
        ...
        virulence: "**Toxin A (enterotoxin):** activates NF-κB → mucosal inflammation, neutrophil recruitment, fluid secretion.\n**Toxin B (cytotoxin):** glucosylates Rho GTPases → depolymerizes actin cytoskeleton → epithelial cell death; **more clinically important** than Toxin A.\n**Binary toxin (CDT):** in hypervirulent **NAP1/BI/027** strain → induces microtubule protrusions → increases adherence.\n**Spores** survive for months on surfaces and in the environment; **resistant to alcohol-based hand sanitizers** (soap and water required for decontamination).\n**Risk factors:** recent antibiotics (**clindamycin, fluoroquinolones, cephalosporins** most common), PPIs, hospitalization, age >65, immunosuppression.",
        disease: "**Spectrum of disease:**\n— **Antibiotic-associated diarrhea:** watery, non-bloody; mild; occurs during or weeks after antibiotics.\n— **Pseudomembranous colitis:** watery diarrhea + fever + elevated WBC (often markedly elevated, >30k — 'leukemoid reaction') + abdominal pain/cramping.\n— **Severe colitis:** ileus, colonic distension.\n— **Fulminant colitis:** toxic megacolon (colon diameter >6 cm) → risk of perforation → sepsis → death.\n**Recurrent C. diff:** 20–30% recur after first episode; 40–60% recur after second episode → FMT indicated.",
        lab_diagnosis: "**Gram stain:** large GP rods with subterminal spores (spores rarely visible in stool specimens).\n**Tests (stool — do not test formed stools):**\n— **PCR (NAAT) for toxin B gene:** highest sensitivity (~100%).\n— **Stool toxin EIA (TcdA/TcdB):** lower sensitivity (~75%) but detects active toxin (active disease).\n— **GDH (glutamate dehydrogenase) antigen:** rapid, highly sensitive screening test; positive result requires reflex to toxin EIA or PCR.\n— **Two-step algorithm:** GDH (screen) → toxin EIA/PCR (confirm).\n**Endoscopy:** cream/yellow pseudomembranes (volcanic 'volcano-shaped' plaques on colonic mucosa).\n**Culture:** CCFA agar under anaerobic conditions (yellow, ground-glass, 'horse-manure' odor).",
        tx: "**First episode (non-severe):** **fidaxomicin** × 10 days (preferred — lower recurrence rate) or oral vancomycin × 10 days.\n**Severe:** oral vancomycin × 10 days.\n**Fulminant/toxic megacolon:** oral vancomycin (rectal enema if ileus) + IV metronidazole; **emergency subtotal colectomy** if deteriorating.\n**Recurrent C. diff (≥2 recurrences):** **fecal microbiota transplantation (FMT)** — >90% cure rate.\n**Alternative for recurrence:** bezlotoxumab (anti-Toxin B monoclonal antibody) as adjunct.\n**IV vancomycin does NOT work** (not secreted into the colon lumen).",
      ...
      },
      {
        ...
        disease: "**Gas gangrene (clostridial myonecrosis):**\n— Contaminated traumatic wounds, postoperative wounds, injection sites (IVDUs).\n— Rapidly progressive: severe pain out of proportion → **crepitus** (gas in tissue from fermentation) → bronze/brown skin discoloration → bullae → systemic sepsis and shock.\n— **Imaging:** gas in tissue planes (pathognomonic on CT/X-ray).\n— Life-threatening; mortality >25% even with treatment.\n**Food poisoning (one of the most common causes in US):**\n— Large numbers of spores ingested in reheated meat dishes → germinate in gut → enterotoxin produced.\n— **Onset 8–24h** (unlike B. cereus emetic form at 1–6h).\n— **Watery diarrhea + crampy abdominal pain**; no vomiting, no fever.\n— Self-limited in 12–24h.",
        lab_diagnosis: "**Gram stain (wound):** large, boxcar-shaped GP rods; spores are **not visible** in tissue (spore formation suppressed in vivo — key exam point).\n**Culture:** Anaerobic blood agar — **double-zone β-hemolysis** (inner complete/clear hemolysis + outer partial/greenish hemolysis zone — pathognomonic for C. perfringens).\n**Egg yolk agar (Nagler reaction):** opaque precipitate around colonies due to lecithinase activity (inhibited by specific antitoxin in confirmatory test).\n**Imaging:** gas in tissue planes on plain X-ray or CT.",
      ...
      },
      {
        ...
        virulence: "**Diphtheria toxin** (A-B toxin, encoded by **β-phage (corynephage) tox gene** — only toxigenic strains cause disease):\n— B fragment binds host cell receptor → internalization.\n— A fragment (active enzyme): **ADP-ribosylates elongation factor-2 (EF-2)** → halts protein translocation on ribosome → **cell death in any aerobic tissue** (heart, peripheral nerves, kidneys).\n— Mechanism shared with Pseudomonas exotoxin A (same target, same mechanism).\n**Metachromatic granules (volutin):** polyphosphate storage granules in polar regions; stain red/purple with Albert or Loeffler's stain → pathognomonic 'Chinese character' appearance.",
        disease: "**Pharyngeal diphtheria:**\n— Low-grade fever, sore throat, malaise → **tough, gray, adherent pseudomembrane** on tonsils/pharynx (extends beyond tonsillar pillars onto soft palate — unlike GAS).\n— **Bleeds when forcibly removed** (distinguishes from strep exudate which wipes away cleanly).\n— **'Bull neck'**: massive cervical LAD + soft tissue edema.\n— Airway obstruction from membrane extension.\n**Complications from toxin dissemination (days–weeks later):**\n— **Myocarditis** (heart block, arrhythmias, cardiac failure) — most common cause of death.\n— **Demyelinating neuropathy:** palatal palsy (nasal voice, regurgitation) → oculomotor palsy → peripheral neuropathy.",
        lab_diagnosis: "**Gram stain:** pleomorphic GP rods in 'Chinese letter' (angular/palisade) arrangements.\n**Culture:** **Loeffler's medium** (serum-based — cream-colored colonies in 6–8h; fastest growth). **Tellurite agar** (selective and differential — gray-black colonies due to tellurite reduction).\n**Stains:** **Albert stain** or Loeffler's methylene blue → metachromatic granules (volutin) at poles (blue granules in blue rods).\n**Toxigenicity testing:** **Elek test** (immunodiffusion in agar — precipitin lines confirm toxin production) or **PCR for tox gene**.",
      ...
      },
      {
        ...
        virulence: "**Listeriolysin O (LLO):** cholesterol-dependent pore-forming toxin → **lyses phagosomal membrane** → organism escapes into cytoplasm.\n**ActA:** nucleates host cell actin filaments → **actin 'rocket tail' propulsion** → cell-to-cell spread without extracellular exposure (evades antibodies and complement).\n**Internalins (InlA, InlB):** bind E-cadherin and Met receptor → mediates invasion of intestinal epithelium, placental trophoblasts, and blood-brain barrier endothelium.\n**Cold growth:** grows at **4°C** (refrigerator temperature) — unique among bacterial pathogens; enables contamination of refrigerated foods.\n**Tumbling motility at 25°C** (umbrella-shaped pattern in soft agar).",
        disease: "**Neonatal listeriosis:**\n— **Early-onset (granulomatosis infantiseptica):** in utero or peripartum; septicemia, meningitis, granulomatous lesions in multiple organs; rash.\n— **Late-onset (1–4 weeks):** meningitis, bacteremia — more common; better prognosis.\n**Meningitis in immunocompromised adults:** organ transplant recipients, HIV, prolonged steroids, hematologic malignancies, elderly (>50 years).\n**Maternal listeriosis:** bacteremia in pregnant women → spontaneous abortion, premature labor, intrauterine fetal death. Mother may have only mild flu-like illness.\n**Febrile gastroenteritis** (immunocompetent): self-limited after large inoculum ingestion; no meningitis.\n**Food sources:** unpasteurized dairy (soft cheeses), deli meats/hot dogs, smoked fish, pre-packaged salads.",
        lab_diagnosis: "**Gram stain:** short GP rods or coccobacilli — **easily mistaken for diphtheroids or S. agalactiae** (contamination artifact common).\n**Culture:** Blood agar — small, narrow-zone **β-hemolytic** colonies at 37°C; grows at 4°C (cold enrichment useful for stool).\n**Tests:** **Tumbling motility at 25°C** (umbrella pattern in soft agar — distinguishes from Erysipelothrix). **CAMP test positive** (similar to GBS — enhanced hemolysis adjacent to S. aureus).\n**CSF:** resembles bacterial meningitis pattern (PMN pleocytosis, elevated protein, low glucose).",
    ...
    organisms: [
      {
        ...
        disease: "**Cervicofacial actinomycosis ('lumpy jaw') — most common form:**\n— Indurated, woody-hard swelling of the jaw/neck/cheek following dental extraction, jaw surgery, or trauma.\n— Chronic, slowly progressive with formation of **draining sinus tracts to the overlying skin** discharging sulfur granules.\n— May cross tissue planes and mimic malignancy.\n**Thoracic actinomycosis:**\n— Aspiration of oral secretions → lung abscess, empyema, pleural thickening.\n— Crosses tissue planes into chest wall (rib involvement) — classically mimics **lung cancer or malignant pleural disease** on CT.\n**Abdominal/pelvic actinomycosis:**\n— After bowel perforation, appendectomy, or abdominal surgery.\n— **IUD-associated pelvic actinomycosis:** Actinomyces on Pap smear or endometrial biopsy in an IUD user — classic association.",
      ...
      },
      {
        ...
        disease: "**Pulmonary nocardiosis (most common):**\n— Cavitary pneumonia, lung abscess, nodular infiltrates in **immunocompromised patients** (prolonged corticosteroids, solid organ transplant, hematologic malignancy, HIV/AIDS, alveolar proteinosis).\n— Can mimic tuberculosis or fungal infection on imaging.\n**CNS nocardiosis:**\n— Brain abscess (single or multiple) from **hematogenous spread** from pulmonary focus.\n— Presents with headache, fever, focal neurological deficits in an immunocompromised patient.\n**Cutaneous nocardiosis (immunocompetent):**\n— Traumatic soil inoculation → nodule at inoculation site → **sporotrichoid spread** (ascending nodules along lymphatics — identical to Sporothrix).\n— **Mycetoma (Madura foot):** chronic granulomatous infection of foot with draining sinus tracts.",
